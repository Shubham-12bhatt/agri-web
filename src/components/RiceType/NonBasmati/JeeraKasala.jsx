...
export default function JeeraKasala() {
  const riceVarieties = [
    {
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="bg-white/70 border-2 border-gray-300 rounded-lg p-8 mb-16 max-w-4xl mx-auto">
            <p className="text-gray-700 leading-relaxed text-justify">
              Jeera Kasala Rice is a non-basmati rice variety cultivated in India, particularly in the states of Maharashtra and Gujarat. It is known for its short to medium grain size, aromatic flavor, and unique cooking properties. Jeera Kasala Rice is commonly used in traditional Indian dishes and is appreciated for its distinct taste. Jeera Kasala Rice is a popular choice for daily meals, economical export options, and is widely used in traditional Indian dishes such as biryani, pulao, and khichdi. It cooks quickly and evenly, maintaining a soft texture. Jeera Kasala Rice is often preferred for its aromatic flavor and versatility in various cuisines.
            </p>
          </div>
        </div>
